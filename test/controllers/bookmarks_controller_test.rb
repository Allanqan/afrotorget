...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference('Bookmark.count') do
      post bookmarks_url, params: { bookmark: { company_id: @bookmark.company_id, product_id: @bookmark.product_id } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { company_id: @bookmark.company_id, product_id: @bookmark.product_id } }
