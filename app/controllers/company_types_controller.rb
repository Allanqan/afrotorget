class CompanyTypesController < ApplicationController
  ...
  def create
    ...
    if @company_type.save
      redirect_to @company_type, notice: 'Company type was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @company_type.update(company_type_params)
      redirect_to @company_type, notice: 'Company type was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to company_types_url, notice: 'Company type was successfully destroyed.'
  end
